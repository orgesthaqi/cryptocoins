...
@section('title', 'CoinMarketCap - Trending')
                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                          <div class="py-1" role="none">
                            ...
                            <a href="?time_period=24h" class="text-gray-700 block px-4 py-2 text-sm @if(request('time_period') == '24h') bg-gray-100 text-gray-900 @else text-gray-700 @endif" role="menuitem" tabindex="-1" id="menu-item-0">24h</a>
                            <a href="?time_period=7d" class="text-gray-700 block px-4 py-2 text-sm @if(request('time_period') == '7d') bg-gray-100 @endif" role="menuitem" tabindex="-1" id="menu-item-1">7d</a>
                            <a href="?time_period=30d" class="text-gray-700 block px-4 py-2 text-sm @if(request('time_period') == '30d') bg-gray-100 @endif" role="menuitem" tabindex="-1" id="menu-item-2">30d</a>
                          </div>
                        </div>
                    </div>
                </div>
