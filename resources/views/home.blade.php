    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="flex flex-col mt-8">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        @if(request()->has('start'))
                                            <div class="text-sm leading-5 text-gray-500">
                                                {{ request()->start + ($key + 1) + ((request()->start - 1) * 50) - 1 }}
                                            </div>
                                        @else
                ...
                <div class="flex items-center space-x-1" style="margin-top: 30px;">
                    @for($i = 1; $i <= 20; $i++)
                        <a href="?start={{ $i }}" class="px-4 py-2 text-gray-700 bg-gray-200 rounded-md hover:bg-blue-400 hover:text-white {{ request()->has('start') && request()->start == $i ? 'bg-blue-400 text-white' : '' }}">
                            {{ $i }}
                        </a>
                    @endfor
                </div>
